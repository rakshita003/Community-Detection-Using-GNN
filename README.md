...
![Reading the dataset from the URL](images/importing_dataset.png)
...
![Connections between labeled nodes in the graph](images/graph_connections.png)
...
![GNN Loss with epoch-100](images/gnn_loss_epoch100.png)
